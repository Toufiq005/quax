...
export default function page() {
  return (
    <>
      ...
      />
      <section className="w-full min-h-screen flex flex-col items-center justify-center bg-very-light-gray">
        <div className="wrapper flex items-center justify-center gap-20 w-full pt-28">
        ...
        <div className="wrapper w-full gap-20 flex items-center justify-center pb-28">
          <div className="members-overview w-1/2">
            <h1>Overview</h1>
            <p>
              But I must explain to you how all this mistaken idea of denounci
              pleasure and paling was born and I will give you a complete
              account of the system and expound the actual teachings give you a
              ...
              typesetting industry. Lorem Ipsum has been give you a complete
              ...
              type specimen book.
              <br /><br />
              Lorem Ipsum has been give you a complete
              account of the system and expound the actual teachings the
              industry.
            </p>
          </div>
